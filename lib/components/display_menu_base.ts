...
export abstract class DisplayMenuBase extends BaseComponent {
...
export interface DisplayMenuBaseDISPLAY_MENU_BASE_SCHEMA extends CoreCOMPONENT_SCHEMA, DisplayMenuBaseMENU_TYPES {
    active?: boolean;
    root_item_id?: ID;
