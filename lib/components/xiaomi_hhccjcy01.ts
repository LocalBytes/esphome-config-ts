...
export class XiaomiHhccjcy01Sensor extends BaseComponent<XiaomiHhccjcy01SensorConfig> {
    componentName: string = "xiaomi_hhccjcy01.sensor";
}

export interface XiaomiHhccjcy01SensorConfig extends Esp32BleTrackerESP_BLE_DEVICE_SCHEMA, CoreCOMPONENT_SCHEMA {
    id?: ID;
    mac_address: string;
