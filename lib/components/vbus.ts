...
export interface VbusBinarySensorConfigDeltasolBsPlusRelay1 extends BinarySensorBINARY_SENSOR_SCHEMA {
}

export interface VbusBinarySensorConfigDeltasolBsPlusRelay2 extends BinarySensorBINARY_SENSOR_SCHEMA {
}
