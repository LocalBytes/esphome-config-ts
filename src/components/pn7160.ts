...
export type Pn7160PN7160SCHEMATagTtl = CorePositiveTimePeriodMilliseconds;

export interface Pn7160PN7160SCHEMA extends CoreCOMPONENTSCHEMA {
    dwl_req_pin?: Pin;
    ...
    tag_ttl?: Pn7160PN7160SCHEMATagTtl;
    ven_pin: Pin;
    wkup_req_pin?: Pin;
}

export interface Pn7160SETMESSAGEACTIONSCHEMA {
    id?: ID;
    include_android_app_record?: boolean;
    message: string;
}

export interface Pn7160SIMPLEACTIONSCHEMA {
    id: ID;
}
