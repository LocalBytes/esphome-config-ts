...
import { CoreTimePeriodDict, CorePositiveTimePeriodMilliseconds, CoreCOMPONENT_SCHEMA } from "./esphome.js";
...
export interface Esp32TouchConfigSleepDuration extends CoreTimePeriodDict {
}

export interface Esp32TouchConfigMeasurementDuration extends CoreTimePeriodDict {
}

export interface Esp32TouchConfigIirFilter extends CorePositiveTimePeriodMilliseconds {
}
