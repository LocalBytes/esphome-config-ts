...
export interface Bmp085SensorConfigPressure extends SensorSENSORSCHEMA {
...
export interface Bmp085SensorConfigTemperature extends SensorSENSORSCHEMA {
    accuracy_decimals?: any;
    device_class?: any;
    state_class?: any;
    unit_of_measurement?: any;
...
export interface Bmp085SensorConfig extends CoreCOMPONENTSCHEMA {
    address?: any;
    i2c_id?: ID;
    id?: ID;
