...
import { CorePositiveTimePeriodMilliseconds, CoreENTITY_BASE_SCHEMA, CoreMQTT_COMPONENT_SCHEMA } from "./esphome.js";
...
export interface BinarySensorMULTI_CLICK_TIMING_SCHEMAMinLength extends CorePositiveTimePeriodMilliseconds {
}

export interface BinarySensorMULTI_CLICK_TIMING_SCHEMAMaxLength extends CorePositiveTimePeriodMilliseconds {
}

export interface BinarySensorBINARY_SENSOR_SCHEMA extends CoreENTITY_BASE_SCHEMA, CoreMQTT_COMPONENT_SCHEMA {
    id?: ID;
    mqtt_id?: any;
