...
export interface DsmrConfigRequestInterval extends CorePositiveTimePeriodMilliseconds {
}

export interface DsmrConfigReceiveTimeout extends CorePositiveTimePeriodMilliseconds {
}
...
export interface DsmrTextSensorConfigIdentification extends TextSensorTEXT_SENSOR_SCHEMA {
}

export interface DsmrTextSensorConfigP1Version extends TextSensorTEXT_SENSOR_SCHEMA {
}

export interface DsmrTextSensorConfigP1VersionBe extends TextSensorTEXT_SENSOR_SCHEMA {
}

export interface DsmrTextSensorConfigTimestamp extends TextSensorTEXT_SENSOR_SCHEMA {
}

export interface DsmrTextSensorConfigElectricityTariff extends TextSensorTEXT_SENSOR_SCHEMA {
}

export interface DsmrTextSensorConfigElectricityFailureLog extends TextSensorTEXT_SENSOR_SCHEMA {
}

export interface DsmrTextSensorConfigMessageShort extends TextSensorTEXT_SENSOR_SCHEMA {
}

export interface DsmrTextSensorConfigMessageLong extends TextSensorTEXT_SENSOR_SCHEMA {
}

export interface DsmrTextSensorConfigGasEquipmentId extends TextSensorTEXT_SENSOR_SCHEMA {
}

export interface DsmrTextSensorConfigThermalEquipmentId extends TextSensorTEXT_SENSOR_SCHEMA {
}

export interface DsmrTextSensorConfigWaterEquipmentId extends TextSensorTEXT_SENSOR_SCHEMA {
}

export interface DsmrTextSensorConfigSubEquipmentId extends TextSensorTEXT_SENSOR_SCHEMA {
}

export interface DsmrTextSensorConfigGasDeliveredText extends TextSensorTEXT_SENSOR_SCHEMA {
}
