...
export interface SensorSENSOR_SCHEMA extends CoreENTITY_BASE_SCHEMA, CoreMQTT_COMPONENT_SCHEMA {
    mqtt_id?: any;
    id?: ID;
...
export interface SensorSENSOR_SCHEMAExpireAfter extends CorePositiveTimePeriodMilliseconds {
}
...
export interface SensorTIMEOUT_SCHEMATimeout extends CorePositiveTimePeriodMilliseconds {
}
