...
export interface Ili9xxxDisplayConfig extends DisplayFULL_DISPLAY_SCHEMA, CoreCOMPONENT_SCHEMA {
    id?: ID;
...
export type Ili9xxxDisplayConfigModel = 'M5STACK' | 'M5CORE' | 'TFT_2.4' | 'TFT_2.4R' | 'ILI9341' | 'ILI9342' | 'ILI9481' | 'ILI9486' | 'ILI9488' | 'ILI9488_A' | 'ST7796' | 'S3BOX' | 'S3BOX_LITE';
