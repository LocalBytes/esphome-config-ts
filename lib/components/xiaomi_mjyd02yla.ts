...
export class XiaomiMjyd02ylaBinarySensor extends BaseComponent<XiaomiMjyd02ylaBinarySensorConfig> {
    componentName: string = "xiaomi_mjyd02yla.binary_sensor";
}

export interface XiaomiMjyd02ylaBinarySensorConfig extends BinarySensorBINARY_SENSOR_SCHEMA, Esp32BleTrackerESP_BLE_DEVICE_SCHEMA, CoreCOMPONENT_SCHEMA {
    id?: any;
    device_class?: any;
    mac_address: string;
    bindkey: string;
