...
export interface Mpu6886SensorConfigAccelX extends Mpu6886SensorAccelSchema {
}

export interface Mpu6886SensorConfigAccelY extends Mpu6886SensorAccelSchema {
}

export interface Mpu6886SensorConfigAccelZ extends Mpu6886SensorAccelSchema {
}

export interface Mpu6886SensorConfigGyroX extends Mpu6886SensorGyroSchema {
}

export interface Mpu6886SensorConfigGyroY extends Mpu6886SensorGyroSchema {
}

export interface Mpu6886SensorConfigGyroZ extends Mpu6886SensorGyroSchema {
}
