...
export class WaveshareEpaperDisplay extends BaseComponent<WaveshareEpaperDisplayConfig> {
    componentName: string = "waveshare_epaper.display";
}

export interface WaveshareEpaperDisplayConfig extends DisplayFULL_DISPLAY_SCHEMA, CoreCOMPONENT_SCHEMA {
    id?: ID;
    dc_pin: Pin;
...
export interface WaveshareEpaperDisplayConfigResetDuration extends CorePositiveTimePeriodMilliseconds {
}
