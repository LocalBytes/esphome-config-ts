 ...
 * 
 * Schema: sdl.json 
 * Source: https://github.com/esphome/esphome/blob/dev/esphome/components/sdl
 * 
...
export interface SdlDisplayConfigDimensions {
    height: number;
    width: number;
}

export interface SdlDisplayConfigWindowOptionsPosition {
    centered_on_display?: number;
    x?: number;
    y?: number;
}

export interface SdlDisplayConfigWindowOptions {
    always_on_top?: boolean;
    borderless?: boolean;
    fullscreen?: boolean;
    position?: SdlDisplayConfigWindowOptionsPosition;
    resizable?: boolean;
...
export interface SdlDisplayConfig extends DisplayFULL_DISPLAY_SCHEMA {
    ...
    id?: ID;
    sdl_options?: any;
    window_options?: SdlDisplayConfigWindowOptions;
    lambda?: any;
    update_interval?: any;
    pages?: any;
}

export class SdlTouchscreen extends EsphomeComponent<SdlTouchscreenConfig> {
